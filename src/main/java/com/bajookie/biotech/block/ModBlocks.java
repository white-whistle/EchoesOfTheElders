...
public class ModBlocks {
    ...
    public static final Block RELIC_CONTAINER_BLOCK = registerBlock("relic_container_block",new RelicContainerBlock(FabricBlockSettings.copyOf(Blocks.STONE).requiresTool().strength(3)));
