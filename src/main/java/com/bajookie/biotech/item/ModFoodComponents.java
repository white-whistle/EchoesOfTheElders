...
public class ModFoodComponents {
    ...
    public static final FoodComponent EXPLORERS_FRUIT = new FoodComponent.Builder().hunger(10).saturationModifier(10f).statusEffect(new StatusEffectInstance(StatusEffects.WEAKNESS,100,1),1).alwaysEdible()
            .statusEffect(new StatusEffectInstance(StatusEffects.SPEED,100,1),1).build();
}
