...
public class ZomBeeModel<T extends ZomBeeEntity>
    ...
    public ZomBeeModel(ModelPart root) {
    ...
    @Override
    public void animateModel(T zomBeeEntity, float f, float g, float h) {
        super.animateModel(zomBeeEntity, f, g, h);
        this.bodyPitch = ((ZomBeeEntity)zomBeeEntity).getBodyPitch(h);
