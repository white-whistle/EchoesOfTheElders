...
public class MagmaBulletEntityRenderer extends EntityRenderer<MagmaBullet> {
    ...
    @Override
    public Identifier getTexture(MagmaBullet entity) {
        return TEXTURE;
    }

    @Override
    public void render(MagmaBullet entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
