...
public class HookProjectileRenderer extends EntityRenderer<HookProjectileEntity> {
    ...
    public HookProjectileRenderer(EntityRendererFactory.Context ctx, float scale, boolean lit) {
        super(ctx);
    ...
    public void render(HookProjectileEntity entity, float yaw, float tickDelta, MatrixStack matrices,
        ...
        this.itemRenderer.renderItem(ModItems.HOOK_RELIC.getDefaultStack(), ModelTransformationMode.GROUND, light, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers, ((Entity)entity).getWorld(), ((Entity)entity).getId());
        matrices.pop();
        super.render(entity, yaw, tickDelta, matrices, vertexConsumers, light);
        PlayerEntity playerEntity = (PlayerEntity) entity.getOwner(); // big issue!
